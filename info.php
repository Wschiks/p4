...
<body>
    ...
    <section id="reis_info">
        ...
        <div class="vluchtinfoplaats">
            ...
            <form method="POST" action="data/dataWinkelmand.php">
                <input type="hidden" name="tripID" value="<?php echo $tripID; ?>">
                <input class="zoek opmaak" type="submit" value="Toevoegen">
